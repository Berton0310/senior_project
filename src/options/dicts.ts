export const defaultDicts = {
  fonts: [
    ...
    {
      label: { en_US: 'Songti', zh_CN: '宋体', zh_TW: '宋體', ru_RU: 'Songti' },
      value: 'SimSun',
    },
    {
      label: { en_US: 'Heiti', zh_CN: '黑体', zh_TW: '黑體', ru_RU: 'Heiti' },
      value: 'SimHei',
    },
    {
      label: { en_US: 'Kaiti', zh_CN: '楷体', zh_TW: '楷體', ru_RU: 'Kaiti' },
      value: 'KaiTi',
    },
    {
      label: {
  ...
  emojis: [
    ...
    {
      label: { en_US: 'Flags', zh_CN: '旗帜', zh_TW: '旗幟', ru_RU: 'Флаги' },
      items: '🏁 🚩 🏴 🏳️ 🏳️‍🌈‍',
    },
  ],
  pageSizes: [
